...
const sequelizeSisplan = new Sequelize(dbConfig.sisplan.database, dbConfig.sisplan.username, dbConfig.sisplan.password, dbConfig.sisplan);
const sequelizeAmalfisCli = new Sequelize(dbConfig.amalfisCli.database, dbConfig.amalfisCli.username, dbConfig.amalfisCli.password, dbConfig.amalfisCli);
