...
module.exports = (sequelize, DataTypes) => {
  class UserPermissionAccess extends Model {
    static associate(models) {
      ...
      UserPermissionAccess.belongsTo(models.Usuario, { foreignKey: 'usuario_id', as: 'usuario' });
      // Relacionamento com Permissão
      UserPermissionAccess.belongsTo(models.Permissao, { foreignKey: 'permissao_id', as: 'permissao' });
    }
  }
