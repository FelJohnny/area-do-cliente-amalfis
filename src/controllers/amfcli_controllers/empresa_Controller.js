...
class Empresa_Controller extends Controller {
    ...
    async pegaTodasEmpresas_Controller(req, res) {
        try {
            const listaDeEmpresas = await empresa_services.pegaTodasEmpresas_Services();
            return res.status(200).json(listaDeEmpresas);
        } catch (e) {
            console.log(e);
            return res.status(500).json({ message: 'Erro ao buscar empresas, contate o administrador do sistema' });
        }
    }
    ...
    async criaEmpresa_Controller(req, res) {
        ...
        try {
            ...
            console.log(e);
            return res.status(400).json({ message: 'Erro ao criar empresa, contate o administrador do sistema' });
        }
    }
    ...
    async pegaEmpresaPorId_Controller(req, res) {
        ...
        try {
            ...
            if (!empresa) {
                return res.status(400).json({ message: `Não foi possível encontrar a empresa com o ID: ${id}` });
            } else {
                return res.status(200).json(empresa);
            }
        } catch (e) {
            console.log(e);
            return res.status(500).json({ message: 'Erro ao buscar empresa, contate o administrador do sistema' });
        }
    }
    ...
    async deletaEmpresaPorId_Controller(req, res) {
        ...
        try {
            ...
            console.log(e);
            return res.status(500).json({ message: 'Erro ao deletar empresa, contate o administrador do sistema' });
        }
    }
    ...
    async atualizaEmpresaPorId_Controller(req, res) {
        ...
        try {
            ...
            return res.status(200).json({ message: `Empresa com o ID ${id} atualizada com sucesso`, empresaAtualizada });
        } catch (e) {
            console.log(e);
            return res.status(500).json({ message: 'Erro ao atualizar empresa, contate o administrador do sistema' });
        }
    }
}
