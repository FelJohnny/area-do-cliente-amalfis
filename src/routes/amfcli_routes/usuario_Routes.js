...
route.put('/api/usuario/:id', checkTokenLogin, (req, res) => usuario_controller.atualizaUsuario_Controller(req, res));
route.get('/api/usuarios', checkTokenLogin, (req, res) => usuario_controller.pegaTodosUsuarios_Controller(req, res));
